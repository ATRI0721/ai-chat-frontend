...
export const MessageList = ({ messages, loading }: {messages: Message[], loading: boolean}) => {
          ...
          {message.role === "user" ? (
            ...
            <div className="flex">
              ...
              <div className="w-full">
                {loading && message.content === "" ? <div>正在生成中...</div> :<MarkdownRenderer content={message.content} />}
